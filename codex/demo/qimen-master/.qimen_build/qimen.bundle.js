(() => {
  ...
  // lib/jiuxing.js
  var require_jiuxing = __commonJS({
    "lib/jiuxing.js"(exports, module) {
      var LUO_SHU_ORDER = ["1", "8", "3", "4", "9", "2", "7", "6"];
      var BASIC_XING = {
        "1": "\u5929\u84EC",
        "8": "\u5929\u4EFB",
        "3": "\u5929\u51B2",
  ...
  // lib/bamen.js
  var require_bamen = __commonJS({
    "lib/bamen.js"(exports, module) {
      var LUO_SHU_ORDER = ["1", "8", "3", "4", "9", "2", "7", "6"];
      var BASIC_MEN = {
        "1": "\u4F11\u95E8",
        "8": "\u751F\u95E8",
      ...
      function distributeBaMen(zhiFuGong, shiGanZhi, type = "yang") {
        ...
        const zhiShiGongRaw = g.toString();
        ...
        return { zhiShiGong, zhiShiGongRaw, zhiShiMen, baMen };
      }
      module.exports = {
        distributeBaMen
      };
  ...
  // lib/bashen.js
  var require_bashen = __commonJS({
    "lib/bashen.js"(exports, module) {
  ...
  // lib/dipan.js
  var require_dipan = __commonJS({
    "lib/dipan.js"(exports, module) {
  ...
  // lib/jieduan.js
  var require_jieduan = __commonJS({
    "lib/jieduan.js"(exports, module) {
      var { diPan: GONG_INFO } = require_constants();
      var SHENG = { mu: "huo", huo: "tu", tu: "jin", jin: "shui", shui: "mu" };
      var KE = { mu: "tu", tu: "shui", shui: "huo", huo: "jin", jin: "mu" };
      var WUXING_CN = { mu: "\u6728", huo: "\u706B", tu: "\u571F", jin: "\u91D1", shui: "\u6C34" };
      function sheng(a, b) {
        return !!a && !!b && SHENG[a] === b;
      }
      function ke(a, b) {
        return !!a && !!b && KE[a] === b;
      }
      ...
      var GAN_YANG = /* @__PURE__ */ new Set(["\u7532", "\u4E19", "\u620A", "\u5E9A", "\u58EC"]);
      var XING_INFO = {
      ...
      var FAMOUS_KEYING = /* @__PURE__ */ new Set([
        "\u9752\u9F99\u8FD4\u9996",
        "\u98DE\u9E1F\u8DCC\u7A74",
        "\u8367\u5165\u592A\u767D",
        "\u592A\u767D\u5165\u8367",
      ...
      var LIUYI_JIXING_GONG = { "\u620A": "3", "\u5DF1": "2", "\u5E9A": "8", "\u8F9B": "9", "\u58EC": "4", "\u7678": "4" };
      var SANQI_DESHI = /* @__PURE__ */ new Set(["\u4E59\u5DF1", "\u4E59\u8F9B", "\u4E19\u620A", "\u4E19\u5E9A", "\u4E01\u58EC", "\u4E01\u7678"]);
      var SANQI_RUMU_GONG = { "\u4E59": "2", "\u4E19": "6", "\u4E01": "6" };
      var XING_BENWEI = { "\u5929\u84EC": "1", "\u5929\u82AE": "2", "\u5929\u51B2": "3", "\u5929\u8F85": "4", "\u5929\u79BD": "5", "\u5929\u5FC3": "6", "\u5929\u67F1": "7", "\u5929\u4EFB": "8", "\u5929\u82F1": "9" };
      var DUI_GONG = { "1": "9", "9": "1", "2": "8", "8": "2", "3": "7", "7": "3", "4": "6", "6": "4" };
      var JIXIONG_TEXT = { da_ji: "\u5927\u5409", xiao_ji: "\u5C0F\u5409", ping: "\u5E73", xiao_xiong: "\u5C0F\u51F6", da_xiong: "\u5927\u51F6" };
      ...
      function analyzeGongDeep(g, pan) {
        ...
        if (xingGongRel === "\u751F\u5165") score += 1;
        else if (xingGongRel === "\u6BD4\u548C") score += 0.5;
        else if (xingGongRel === "\u514B\u5165") score -= 1;
        else if (xingGongRel === "\u751F\u51FA") score += 0.5;
        const menGongRel = relation(menInfo.element, gongEl);
        let menPo = false;
        if (menGongRel === "\u514B\u51FA") {
          score -= 2;
          menPo = true;
        } else if (menGongRel === "\u514B\u5165") score -= 1;
        else if (menGongRel === "\u751F\u5165") score += 1;
        else if (menGongRel === "\u6BD4\u548C") score += 1;
        else if (menGongRel === "\u751F\u51FA") score += 0.5;
      ...
      function relText(rel, subject, object) {
        switch (rel) {
          case "\u6BD4\u548C":
            return `${subject}\u4E0E${object}\u6BD4\u548C\uFF0C\u6C14\u52BF\u76F8\u901A`;
          case "\u751F\u5165":
            return `${object}\u751F${subject}\uFF0C\u5F97\u751F\u6709\u529B`;
          case "\u751F\u51FA":
            return `${subject}\u751F${object}\uFF0C\u6CC4\u6C14\u8017\u529B`;
          case "\u514B\u51FA":
            return `${subject}\u514B${object}`;
          case "\u514B\u5165":
            return `${object}\u514B${subject}\uFF0C\u53D7\u5236\u4E0D\u5229`;
          default:
            return "";
        }
      }
      function buildExplain(a) {
        ...
        switch (a.jiXiong) {
          case "da_ji":
            parts.push("\u7EFC\u65AD\u6B64\u5BAB\u5927\u5409\uFF0C\u53EF\u4E3B\u52A8\u8FDB\u53D6\u3002");
            break;
          case "xiao_ji":
            parts.push("\u7EFC\u65AD\u6B64\u5BAB\u5C0F\u5409\uFF0C\u7A33\u6B65\u63A8\u8FDB\u4E3A\u5B9C\u3002");
            break;
          case "ping":
            parts.push("\u7EFC\u65AD\u6B64\u5BAB\u5E73\u5E73\uFF0C\u6309\u90E8\u5C31\u73ED\u3001\u8C28\u614E\u884C\u4E8B\u3002");
            break;
          case "xiao_xiong":
            parts.push("\u7EFC\u65AD\u6B64\u5BAB\u5C0F\u51F6\uFF0C\u591A\u6709\u963B\u788D\uFF0C\u5B9C\u5B88\u4E0D\u5B9C\u8FDB\u3002");
            break;
          case "da_xiong":
            parts.push("\u7EFC\u65AD\u6B64\u5BAB\u5927\u51F6\uFF0C\u9669\u963B\u91CD\u91CD\uFF0C\u5B9C\u907F\u5176\u65B9\u3001\u907F\u5176\u4E8B\u3002");
            break;
        }
        return parts.join(" ");
      }
      function detectGeju(pan) {
        ...
        if (dayGan && timeGan && ke(GAN_WUXING[timeGan], GAN_WUXING[dayGan]) && GAN_YANG.has(timeGan) === GAN_YANG.has(dayGan)) {
  ...
  var require_qimen = __commonJS({
    "lib/qimen.js"(exports, module) {
      var { Lunar, Solar, JieQi } = require_lunar_javascript();
      var jiuXingModule = require_jiuxing();
      var baMenModule = require_bamen();
      var baShenModule = require_bashen();
      var diPanModule = require_dipan();
      var jieduanModule = require_jieduan();
      var JIU_GONG = {
      ...
      function getFuTouZhi(dayGanZhi) {
        const TG = ["\u7532", "\u4E59", "\u4E19", "\u4E01", "\u620A", "\u5DF1", "\u5E9A", "\u8F9B", "\u58EC", "\u7678"];
        const DZ = ["\u5B50", "\u4E11", "\u5BC5", "\u536F", "\u8FB0", "\u5DF3", "\u5348", "\u672A", "\u7533", "\u9149", "\u620C", "\u4EA5"];
        const gi = TG.indexOf(dayGanZhi.charAt(0));
        const zi = DZ.indexOf(dayGanZhi.charAt(1));
        if (gi < 0 || zi < 0) return dayGanZhi.substring(1);
        let n = 0;
        for (; n < 60; n++) {
          if (n % 10 === gi && n % 12 === zi) break;
        }
        const fuTou = n - n % 5;
        return DZ[fuTou % 12];
      }
      function calculateJuShu(date, method = "\u65F6\u5BB6") {
        ...
        if (method === "\u65F6\u5BB6" || method === "\u65E5\u5BB6") {
          ...
          const liChun = Lunar.fromYmd(year, 2, 4).getPrevJieQi(true);
        ...
        let diZhi;
        if (method === "\u65F6\u5BB6" || method === "\u65E5\u5BB6") {
          diZhi = getFuTouZhi(ganZhi);
        } else {
          diZhi = ganZhi.substring(1);
        }
        let yuan;
        ...
        for (const item of JIE_QI_JU_SUAN) {
          if (item.jieqi === jieQiName) {
            yinYangType = item.type === "yin" ? "yin" : "yang";
      ...
      function calculateAnGan(shiGan, xunShouYi, zhiShiGongRaw, type) {
        const SAN_QI_LIU_YI = ["\u620A", "\u5DF1", "\u5E9A", "\u8F9B", "\u58EC", "\u7678", "\u4E01", "\u4E19", "\u4E59"];
        const anGan = {};
        const isJia = shiGan === "\u7532";
        const shiYi = isJia ? xunShouYi : shiGan;
        const anchor = isJia ? 5 : parseInt(zhiShiGongRaw, 10);
        const startIdx = SAN_QI_LIU_YI.indexOf(shiYi);
        let currentGong = anchor;
        for (let i = 0; i < 9; i++) {
          anGan[currentGong.toString()] = SAN_QI_LIU_YI[(startIdx + i) % 9];
          if (type === "yin") {
            currentGong--;
            if (currentGong === 0) currentGong = 9;
          } else {
      ...
      function calculate(date, options = {}) {
        ...
        try {
          ...
          const baMenResult = baMenModule.distributeBaMen(jiuXingResult.zhiFuGong, siZhu.time, juShu.type);
          const baShen = baShenModule.distributeBaShen(jiuXingResult.zhiFuLuoGong || jiuXingResult.zhiFuGong, juShu.type);
          const anGan = calculateAnGan(siZhu.time.charAt(0), xunShou, baMenResult.zhiShiGongRaw, juShu.type);
          const pan = {
            basicInfo: {
          ...
          const { jiuGongAnalysis, geju, analysis } = jieduanModule.jieduan(pan);
          pan.jiuGongAnalysis = jiuGongAnalysis;
          pan.geju = geju;
          pan.analysis = analysis;
          return pan;
        } catch (e) {
  ...
  // .qimen_build/entry.js
  var qimen = require_qimen();
